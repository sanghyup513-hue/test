MD=/data/lsh/mlperf_inference_storage/models/Llama3.1-405B/Meta-Llama-3.1-405B-Instruct
hf download meta-llama/Llama-3.1-405B-Instruct config.json --local-dir "$MD"
ls -la "$MD"/config.json
...
srun --gres=gpu:1 --time=01:00:00 \
  ...
  MD=/data/lsh/mlperf_inference_storage/models/Llama3.1-405B/Meta-Llama-3.1-405B-Instruct
hf download meta-llama/Llama-3.1-405B-Instruct config.json --local-dir "$MD"
ls "$MD"/config.json "$MD"/tokenizer.json
